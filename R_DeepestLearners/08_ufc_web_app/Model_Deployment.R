...
# About This Script:     - This script is not runnable. Only the functions will be called from The App on source.
#                        - This script provoides set of functions to
#                          handle the logic of the app
#                        - Performs Data Extraction and Passing a row of data to predict
# 
# ************************************************
